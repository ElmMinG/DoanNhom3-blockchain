...
### Yêu cầu tiên quyết
1. Trình duyệt Chrome/Edge có cài tiện ích **MetaMask**.
2. Trong ví có sẵn **Sepolia ETH** (Lấy miễn phí tại [Sepolia Faucet](https://sepoliafaucet.com/)).

### Bước 1: Tải mã nguồn
Clone repository này về máy tính của bạn:

```bash
git clone [https://github.com/ElmMinG/DoanNhom3-blockchain.git](https://github.com/ElmMinG/DoanNhom3-blockchain.git)
...
* *Khuyên dùng:* Extension **Live Server** trên VS Code để chạy mượt mà nhất.


3. Ứng dụng sẽ tự động chuyển hướng về trang Đăng nhập.
...
1. Chuyển MetaMask sang mạng **Sepolia**.
2. Bấm nút **"Kết nối Ví"** trên giao diện ứng dụng.
